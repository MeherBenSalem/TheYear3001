...
@Mod("robotica")
public class RoboticaMod {
	public static final Logger LOGGER = LogManager.getLogger(RoboticaMod.class);
	public static final String MODID = "robotica";

	public RoboticaMod(FMLJavaModLoadingContext context) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		MinecraftForge.EVENT_BUS.register(this);
		IEventBus bus = context.getModEventBus();
		RoboticaModSounds.REGISTRY.register(bus);
		RoboticaModBlocks.REGISTRY.register(bus);
		RoboticaModBlockEntities.REGISTRY.register(bus);
		RoboticaModItems.REGISTRY.register(bus);
		RoboticaModEntities.REGISTRY.register(bus);

		RoboticaModTabs.REGISTRY.register(bus);

		RoboticaModMenus.REGISTRY.register(bus);
		RoboticaModFluids.REGISTRY.register(bus);
