...
import tn.nightbeam.robotica.init.RoboticaModJeiPlugin;
...
public class ExtendedCraftingRecipeCategory implements IRecipeCategory<ExtendedCraftingRecipe> {
	public final static ResourceLocation UID = new ResourceLocation("robotica", "extended_crafting");
	public final static ResourceLocation TEXTURE = new ResourceLocation("robotica", "textures/screens/jei_render.png");
	private final IDrawable background;
	private final IDrawable icon;

	public ExtendedCraftingRecipeCategory(IGuiHelper helper) {
		this.background = helper.createDrawable(TEXTURE, 0, 0, 176, 85);
		this.icon = helper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack(RoboticaModBlocks.CRAFTING_WORKSTATION.get().asItem()));
	}

	@Override
	public mezz.jei.api.recipe.RecipeType<ExtendedCraftingRecipe> getRecipeType() {
		return RoboticaModJeiPlugin.ExtendedCrafting_Type;
	}
