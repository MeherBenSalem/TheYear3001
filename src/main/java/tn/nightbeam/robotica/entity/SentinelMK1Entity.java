...
public class SentinelMK1Entity extends Monster implements GeoEntity {
	...
	public SentinelMK1Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(RoboticaModEntities.SENTINEL_MK_1.get(), world);
	}
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "robot_1");
	}
	...
	public SoundEvent getAmbientSound() {
		return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("robotica:alient_robot_ambient"));
	}
	...
	public static void init() {
		SpawnPlacements.register(RoboticaModEntities.SENTINEL_MK_1.get(), SpawnPlacements.Type.NO_RESTRICTIONS, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, Mob::checkMobSpawnRules);
		DungeonHooks.addDungeonMob(RoboticaModEntities.SENTINEL_MK_1.get(), 180);
	}
