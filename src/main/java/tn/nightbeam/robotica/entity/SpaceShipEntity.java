...
public class SpaceShipEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public SpaceShipEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(RoboticaModEntities.SPACE_SHIP.get(), world);
	}
