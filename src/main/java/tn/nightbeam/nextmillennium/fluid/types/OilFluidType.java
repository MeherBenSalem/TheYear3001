...
package tn.nightbeam.nextmillennium.fluid.types;
...
public class OilFluidType extends FluidType {
	...
	public void initializeClient(Consumer<IClientFluidTypeExtensions> consumer) {
		consumer.accept(new IClientFluidTypeExtensions() {
			private static final ResourceLocation STILL_TEXTURE = new ResourceLocation("theyear3001:block/oil_still");
			private static final ResourceLocation FLOWING_TEXTURE = new ResourceLocation("theyear3001:block/oil_still");
