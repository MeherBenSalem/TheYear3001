package tn.nightbeam.nextmillennium.client.gui;

import tn.nightbeam.nextmillennium.world.inventory.CraftingWorkStationGUIMenu;
import tn.nightbeam.nextmillennium.network.CraftingWorkStationGUIButtonMessage;
...
public class CraftingWorkStationGUIScreen extends AbstractContainerScreen<CraftingWorkStationGUIMenu> {
	...
	private static final ResourceLocation texture = new ResourceLocation("theyear3001:textures/screens/crafting_work_station_gui.png");
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
		...
		guiGraphics.blit(new ResourceLocation("theyear3001:textures/screens/arrow.png"), this.leftPos + 102, this.topPos + 36, 0, 0, 22, 14, 22, 14);
	...
	public void init() {
		super.init();
		imagebutton_forge_button = new ImageButton(this.leftPos + 104, this.topPos + 52, 18, 18, 0, 0, 18, new ResourceLocation("theyear3001:textures/screens/atlas/imagebutton_forge_button.png"), 18, 36, e -> {
			if (true) {
				Theyear3001Mod.PACKET_HANDLER.sendToServer(new CraftingWorkStationGUIButtonMessage(0, x, y, z));
