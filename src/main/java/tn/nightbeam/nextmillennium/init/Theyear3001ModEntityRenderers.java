...
import tn.nightbeam.nextmillennium.client.renderer.RobotMK1Renderer;
...
public class Theyear3001ModEntityRenderers {
	...
	public static void registerEntityRenderers(EntityRenderersEvent.RegisterRenderers event) {
		event.registerEntityRenderer(Theyear3001ModEntities.ROBOT_MK_1.get(), RobotMK1Renderer::new);
