...
import tn.nightbeam.nextmillennium.procedures.FlyCapsuleGoUpOnKeyPressedProcedure;
...
public class FlyCapsuleGoUpMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		Theyear3001Mod.addNetworkMessage(FlyCapsuleGoUpMessage.class, FlyCapsuleGoUpMessage::buffer, FlyCapsuleGoUpMessage::new, FlyCapsuleGoUpMessage::handler);
	}
}
