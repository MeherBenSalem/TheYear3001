...
public class FlyCapsuleGoForwardMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		Theyear3001Mod.addNetworkMessage(FlyCapsuleGoForwardMessage.class, FlyCapsuleGoForwardMessage::buffer, FlyCapsuleGoForwardMessage::new, FlyCapsuleGoForwardMessage::handler);
	}
}
