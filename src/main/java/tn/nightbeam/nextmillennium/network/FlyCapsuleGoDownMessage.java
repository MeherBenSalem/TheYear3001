...
public class FlyCapsuleGoDownMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		Theyear3001Mod.addNetworkMessage(FlyCapsuleGoDownMessage.class, FlyCapsuleGoDownMessage::buffer, FlyCapsuleGoDownMessage::new, FlyCapsuleGoDownMessage::handler);
	}
}
