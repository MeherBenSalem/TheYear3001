...
@Mod("theyear3001")
public class Theyear3001Mod {
	public static final Logger LOGGER = LogManager.getLogger(Theyear3001Mod.class);
	public static final String MODID = "theyear3001";

	public Theyear3001Mod() {
		...
		Theyear3001ModEntities.REGISTRY.register(bus);

		Theyear3001ModTabs.REGISTRY.register(bus);

		Theyear3001ModMenus.REGISTRY.register(bus);
		Theyear3001ModFluids.REGISTRY.register(bus);
		Theyear3001ModFluidTypes.REGISTRY.register(bus);
