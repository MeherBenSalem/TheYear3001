...
public class RoboticaModFabricClient implements ClientModInitializer {
	...
	public void onInitializeClient() {
		...
		ResourceLocation still = ResourceLocation.fromNamespaceAndPath(RoboticaMod.MOD_ID, "block/oil_still");
		ResourceLocation flowing = ResourceLocation.fromNamespaceAndPath(RoboticaMod.MOD_ID, "block/oil_flow");
