...
public class RoboticaModItemsForge {
	public static final DeferredRegister<Item> REGISTRY = DeferredRegister.create(ForgeRegistries.ITEMS, RoboticaMod.MOD_ID);
	...
	public static final RegistryObject<Item> SCRAP_BLOCK = block(RoboticaModBlocksForge.SCRAP_BLOCK);
	public static final RegistryObject<Item> CRAFTING_WORKSTATION = block(RoboticaModBlocksForge.CRAFTING_WORKSTATION);
	...
	public static final RegistryObject<Item> SCRAP_SLAB = block(RoboticaModBlocksForge.SCRAP_SLAB);
	public static final RegistryObject<Item> SCRAP_STAIRS_BLOCK = block(RoboticaModBlocksForge.SCRAP_STAIRS_BLOCK);
	public static final RegistryObject<Item> SPACE_SHIP_CAPSULE = REGISTRY.register("space_ship_capsule", () -> new FlyingCapsuleItem());
	public static final RegistryObject<Item> SCRAP_DEBRIS = block(RoboticaModBlocksForge.SCRAP_DEBRIS);
	public static final RegistryObject<Item> TITANIUM_ORE = block(RoboticaModBlocksForge.TITANIUM_ORE);
	...
	public static final RegistryObject<Item> COBALT_ORE = block(RoboticaModBlocksForge.COBALT_ORE);
	public static final RegistryObject<Item> ORICHALCUM_ORE = block(RoboticaModBlocksForge.ORICHALCUM_ORE);
	...
	public static final RegistryObject<Item> SENTINEL_SPAWN_EGG = REGISTRY.register("sentinel_spawn_egg", () -> new ForgeSpawnEggItem(RoboticaModEntitiesForge.SENTINEL, -13421773, -6710887, new Item.Properties()));
