...
public final class RoboticaModFluidsFabric {
	...
	public static void register() {
		ResourceLocation oilId = new ResourceLocation(RoboticaMod.MOD_ID, "oil");
		ResourceLocation flowingOilId = new ResourceLocation(RoboticaMod.MOD_ID, "flowing_oil");
		ResourceLocation oilBlockId = new ResourceLocation(RoboticaMod.MOD_ID, "oil");
