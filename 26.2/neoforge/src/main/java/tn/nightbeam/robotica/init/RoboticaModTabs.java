...
public class RoboticaModTabs {
	public static final DeferredRegister<CreativeModeTab> REGISTRY = DeferredRegister.create(Registries.CREATIVE_MODE_TAB, RoboticaMod.MOD_ID);
	public static final DeferredHolder<CreativeModeTab, CreativeModeTab> THE_YEAR_3001_TAB = REGISTRY.register("the_year_3001_tab",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.robotica.the_year_3001_tab")).icon(() -> new ItemStack(RoboticaModItems.PRINTED_CIRCUIT_BOARD.get())).displayItems((parameters, tabData) -> {
				...
				tabData.accept(RoboticaModBlocksNeoForge.SCRAP_BLOCK.get().asItem());
				tabData.accept(RoboticaModBlocks.SCRAP_SLAB.get().asItem());
				tabData.accept(RoboticaModBlocks.SCRAP_STAIRS_BLOCK.get().asItem());
				tabData.accept(RoboticaModBlocksNeoForge.CRAFTING_WORKSTATION.get().asItem());
	...
	public static final DeferredHolder<CreativeModeTab, CreativeModeTab> THE_YEAR_3001_CARDS = REGISTRY.register("the_year_3001_cards",
