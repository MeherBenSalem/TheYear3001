	...
	public static void execute(Entity entity, Entity sourceentity) {
		...
		if ((sourceentity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == RoboticaModItems.REPAIR_CARD.get()) {
			...
			if (sourceentity instanceof Player _player && !_player.level().isClientSide())
				_player.sendSystemMessage(Component.literal(("Upgraded " + entity.getDisplayName().getString() + " max health to "
						+ (entity instanceof LivingEntity _livingEntity11 && _livingEntity11.getAttributes().hasAttribute(Attributes.MAX_HEALTH) ? _livingEntity11.getAttribute(Attributes.MAX_HEALTH).getValue() : 0))));
			if (entity instanceof LivingEntity _entity)
			...
			if (sourceentity instanceof Player _player && !_player.level().isClientSide())
				_player.sendSystemMessage(Component.literal(("Upgraded " + entity.getDisplayName().getString() + " damage to "
						+ (entity instanceof LivingEntity _livingEntity22 && _livingEntity22.getAttributes().hasAttribute(Attributes.ATTACK_DAMAGE) ? _livingEntity22.getAttribute(Attributes.ATTACK_DAMAGE).getValue() : 0))));
			if (sourceentity instanceof Player _player) {
			...
			if (sourceentity instanceof Player _player && !_player.level().isClientSide())
				_player.sendSystemMessage(Component.literal(("Upgraded " + entity.getDisplayName().getString() + " movement speed to "
						+ (entity instanceof LivingEntity _livingEntity31 && _livingEntity31.getAttributes().hasAttribute(Attributes.MOVEMENT_SPEED) ? _livingEntity31.getAttribute(Attributes.MOVEMENT_SPEED).getValue() : 0))));
			if (sourceentity instanceof Player _player) {
			...
			if (sourceentity instanceof Player _player && !_player.level().isClientSide())
				_player.sendSystemMessage(Component.literal(("Upgraded " + entity.getDisplayName().getString() + " armor to "
						+ (entity instanceof LivingEntity _livingEntity40 && _livingEntity40.getAttributes().hasAttribute(Attributes.ARMOR) ? _livingEntity40.getAttribute(Attributes.ARMOR).getValue() : 0))));
			if (sourceentity instanceof Player _player) {
