...
public class RoboticaModFabric implements ModInitializer {
	private static Identifier id(String path) {
		return Identifier.fromNamespaceAndPath(RoboticaMod.MOD_ID, path);
	}
	...
	private void registerEntities() {
		ResourceKey<EntityType<?>> boggieKey = ResourceKey.create(Registries.ENTITY_TYPE, id("boggie"));
		EntityType<BoggieEntity> boggieType = Registry.register(BuiltInRegistries.ENTITY_TYPE, id("boggie"),
				EntityType.Builder.<BoggieEntity>of(BoggieEntity::new, MobCategory.MONSTER).sized(0.6f, 1f)
						.build(boggieKey));
		RoboticaModEntities.BOGGIE = () -> boggieType;
		FabricDefaultAttributeRegistry.register(boggieType, BoggieEntity.createAttributes());

		ResourceKey<EntityType<?>> sentinelKey = ResourceKey.create(Registries.ENTITY_TYPE, id("sentinel"));
		EntityType<SentinelEntity> sentinelType = Registry.register(BuiltInRegistries.ENTITY_TYPE, id("sentinel"),
				EntityType.Builder.<SentinelEntity>of(SentinelEntity::new, MobCategory.MONSTER).sized(0.6f, 3.5f)
						.build(sentinelKey));
		...
		ResourceKey<EntityType<?>> mechKey = ResourceKey.create(Registries.ENTITY_TYPE, id("mech"));
		EntityType<MechEntity> mechType = Registry.register(BuiltInRegistries.ENTITY_TYPE, id("mech"),
				EntityType.Builder.<MechEntity>of(MechEntity::new, MobCategory.MONSTER).sized(2f, 3.7f)
						.build(mechKey));
		RoboticaModEntities.MECH = () -> mechType;
		FabricDefaultAttributeRegistry.register(mechType, MechEntity.createAttributes());

		ResourceKey<EntityType<?>> spaceShipKey = ResourceKey.create(Registries.ENTITY_TYPE, id("space_ship"));
		EntityType<SpaceShipEntity> spaceShipType = Registry.register(BuiltInRegistries.ENTITY_TYPE, id("space_ship"),
				EntityType.Builder.<SpaceShipEntity>of(SpaceShipEntity::new, MobCategory.MONSTER).sized(4f, 2f)
						.build(spaceShipKey));
		RoboticaModEntities.SPACE_SHIP = () -> spaceShipType;
		FabricDefaultAttributeRegistry.register(spaceShipType, SpaceShipEntity.createAttributes());

		Item sentinelSpawnEgg = Registry.register(BuiltInRegistries.ITEM, id("sentinel_spawn_egg"),
				new Item(new Item.Properties().spawnEgg(sentinelType)));
		RoboticaModItems.SENTINEL_SPAWN_EGG = () -> sentinelSpawnEgg;
